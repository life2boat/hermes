...
| Memory Graph v3 | `ai_engineering/graph_contract.py`, `docs/adr/ADR-0081-memory-graph-engineering-v3.md` | Deterministic graph contracts, strict authoritative (SQLite) to derived-graph boundary, explicitly provenance-bound identity, and tamper detection |
