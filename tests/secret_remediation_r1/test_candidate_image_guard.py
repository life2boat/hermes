import pytest
from ops.secret_remediation_r1.candidate_image_guard import verify_legacy_image, CandidateImageGuardError
...
def test_verify_legacy_image_wrong_ref():
    with pytest.raises(CandidateImageGuardError, match="Effective image .* != expected"):
