...
| Effective policy and source attribution | `docs/EFFECTIVE_POLICY_CONTRACT.md`, `docs/adr/ADR-0080-effective-policy-source-attribution.md`, `ai_engineering/effective_policy.py`, `scripts/explain_effective_policy.py`, `tests/ai_engineering/test_effective_policy.py` | Deterministic offline explainability and exact Git-committed source attribution for TaskIntent invariants, required release gates, and task boundaries without authority expansion |
