...
## 12. Memory Graph V3 (PR-6)

PR #204:
PR6_1_MERGED=true
PR6_1_PR_HEAD=6a1d2572186687cf31321435f626bf843b249bd6
PR6_1_MERGE_SHA=db9620284cac8e1fe6af6c8420a1dfbf8194a557
PR6_1_EXACT_MAIN_VALIDATED=true
PR6_1_CORPUS_STATUS=CANDIDATE
PR6_1_CORPUS_DIGEST=6c5df3e4f152cbc48d3b674a37ed5935a62bd327ca1eda2790d9770d9ad92bda
PR6_1_REPORT_DETERMINISTIC=true
PR6_1_F5_HARD_INTEGRITY_CLOSED=true

PR6_TECHNICAL_COMPLETE=true
PR7_ALLOWED=true

## 13. Memory Graph V3 (PR-7)

PR7_REPOSITORY_INTEGRATION_COMPLETE=true
PR7_PR_NUMBER=206
PR7_PR_HEAD=d377b51255437dbab7774b2b637f5d31cba9fc12
PR7_IMPLEMENTATION_MERGE_SHA=e60b2af92226eae0d14c79ca382629613a387e39
PR7_EXACT_HEAD_CI=PASS
PR7_EXACT_MAIN_VALIDATION=PASS
...
## 14. Memory Graph V3 (PR-9 / PR-9R)

PR9_FIRST_ACTIVATION_ATTEMPT=ROLLED_BACK
PR9_BLOCKER=MEMORY_OS_FACTS_SOURCE_SCHEMA_DRIFT
MANUAL_STAGED_SCHEMA_BYPASS_OCCURRED=true
PRODUCTION_RECOVERED=true
GRAPH_SHADOW_PRODUCTION_ACTIVATED=false
SCHEMA_COMPATIBILITY_FIX_MERGED=true
REQUALIFICATION_REQUIRED=true

## 15. HealBite Inventory Canary Contract (Recovery)

PR249_CANARY_CONTRACT_MERGED=true
CANARY_ACTIVATION_MECHANISM=operator_canary_contract
SECRET_OVERRIDE_SUPPORTS_FEATURE_GATES=false
HEALBITE_INVENTORY_PHOTO_ENABLED=false
HEALBITE_INVENTORY_PHOTO_ALLOWLIST=""
EXPECTED_CANONICAL_MAIN_SHA=34d52fa9fd8a2fc1b4c929a00fb0dff751cfadfa
