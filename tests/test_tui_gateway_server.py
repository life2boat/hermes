...
def test_load_enabled_toolsets_rejects_disabled_mcp_env(monkeypatch, capsys):
    ...
    # Sorted: ["kanban", "memory", "nutrition_diary"]. `kanban` and
    # `nutrition_diary` are auto-recovered by _get_platform_tools because
    # they are non-configurable platform toolsets whose tools live in the
    # hermes-cli universe (see toolsets.py).
    assert server._load_enabled_toolsets() == ["kanban", "memory", "nutrition_diary"]
