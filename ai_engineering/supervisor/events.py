...
class SupervisorEventType(StrEnum):
    ...
    ASTRA_PROPOSAL_CREATED = "ASTRA_PROPOSAL_CREATED"
    AGENT_DISPATCH_REQUESTED = "AGENT_DISPATCH_REQUESTED"
    VERIFIED_RESULT_CREATED = "VERIFIED_RESULT_CREATED"
    NEXT_ACTION_SELECTED = "NEXT_ACTION_SELECTED"
    AUTONOMOUS_RUN_COMPLETED = "AUTONOMOUS_RUN_COMPLETED"
    AUTONOMOUS_RUN_BLOCKED = "AUTONOMOUS_RUN_BLOCKED"
    ASTRA_REQUESTED = "ASTRA_REQUESTED"
    ASTRA_PROVIDER_FAILED = "ASTRA_PROVIDER_FAILED"
    CI_WAIT_STARTED = "CI_WAIT_STARTED"
    CI_STATUS_OBSERVED = "CI_STATUS_OBSERVED"
    CI_GREEN = "CI_GREEN"
    CI_WAIT_TIMEOUT = "CI_WAIT_TIMEOUT"
    PR_CREATE_REQUESTED = "PR_CREATE_REQUESTED"
    PR_CREATED = "PR_CREATED"
    PR_RECOVERED = "PR_RECOVERED"
    PR_CREATE_FAILED = "PR_CREATE_FAILED"
    PR_HEAD_CHANGED = "PR_HEAD_CHANGED"
    PR_MERGE_REQUESTED = "PR_MERGE_REQUESTED"
    PR_MERGED = "PR_MERGED"
    PR_MERGE_RECOVERED = "PR_MERGE_RECOVERED"
    PR_MERGE_FAILED = "PR_MERGE_FAILED"
    PR_IDENTITY_UNAVAILABLE = "PR_IDENTITY_UNAVAILABLE"
    PR_HEAD_SHA_MISMATCH = "PR_HEAD_SHA_MISMATCH"
    PR_IDENTITY_MISMATCH = "PR_IDENTITY_MISMATCH"
    PR_IDENTITY_AMBIGUOUS = "PR_IDENTITY_AMBIGUOUS"
    PR_HEAD_NOT_PUBLISHED = "PR_HEAD_NOT_PUBLISHED"
    MAIN_ADVANCED_DURING_QUALIFICATION = "MAIN_ADVANCED_DURING_QUALIFICATION"
    POST_MERGE_ATTESTATION_FAILED = "POST_MERGE_ATTESTATION_FAILED"
    PR_MUTATION_RESULT_UNKNOWN = "PR_MUTATION_RESULT_UNKNOWN"
    MERGE_RESULT_UNKNOWN = "MERGE_RESULT_UNKNOWN"
    CANDIDATE_HEAD_PUBLISHED = "CANDIDATE_HEAD_PUBLISHED"
    MAIN_IDENTITY_UNAVAILABLE = "MAIN_IDENTITY_UNAVAILABLE"
    CANDIDATE_HEAD_IDENTITY_MISSING = "CANDIDATE_HEAD_IDENTITY_MISSING"
    CANDIDATE_HEAD_IDENTITY_REGISTERED = "CANDIDATE_HEAD_IDENTITY_REGISTERED"
    CANDIDATE_HEAD_IDENTITY_INVALID = "CANDIDATE_HEAD_IDENTITY_INVALID"
    REAL_PR_PROVIDER_REQUIRED = "REAL_PR_PROVIDER_REQUIRED"
